  ...
  return (
    <>
      <Card bordered={false}>
        ...
        >
          <StandardFormRow title="Categoría" block style={{ paddingBottom: 11 }}>
          ...
          <StandardFormRow title="Otras opciones" grid last>
            <Row gutter={16}>
              ...
              <Col xl={8} lg={10} md={12} sm={24} xs={24}>
                <FormItem {...formItemLayout} label="Calificacion de" name="rate">
                  <Select
