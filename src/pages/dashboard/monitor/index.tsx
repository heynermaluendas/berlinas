    ...
    <GridContent>
      <>
        <Row gutter={24}>
          ...
          >
            <Card title="Activity real-time transaction status" bordered={false}>
              <Row>
                ...
                <Col md={6} sm={12} xs={24}>
                  <Countdown title="Remaining time of activity" value={deadline} format="HH:mm:ss:SSS" />
                </Col>
                <Col md={6} sm={12} xs={24}>
                  <Statistic title="Total transactions per second" suffix="Yuan" value={numeral(234).format('0,0')} />
                </Col>
              </Row>
        ...
        <Row gutter={24}>
          ...
          >
            <Card title="Proportion of each category" bordered={false}>
              <Row
                style={{
                  padding: '16px 0',
                }}
